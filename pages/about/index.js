...
const aboutData = [
  ...
  },
  {
    ...
    info: [
      ...
      {
        title: "Certified Graphic Designer - ABC Institute, Pakistan, CA",
        stage: "2006",
      },
    ],
  },
...
const About = () => {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left ">
      ...
      >
        <div className="w-[500px] relative top-[35vh] left-[18vh]">
          <Avatar />
        </div>
      </motion.div>
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            3 year ago, I began freelancing as devloper. Since then, I've done
        ...
        >
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4">
            {aboutData.map((item, itemIndex) => {
              ...
              after:w-8 after:h-[2px] after:bg-white after:absolute after:-bottom-1 after:left-0 h-10`}
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
            ...
            <Link
              href={`https://github.com/SAADTheNightWorker`}
              className="max-sm:mt-5 items-center gap-2 hidden max-sm:flex hover:text-red-500 cursor-pointer"
            >
              My git
              <FaGithub />
            </Link>
        ...
        <Link
          className="border max-md:px-5 absolute left-8 bottom-20 py-3 px-12
        ...
        <Link
          className="border max-md:px-5 absolute right-8 bottom-20 py-3 px-12
           hover:text-accent duration-200 hover:border-accent/20
           mb-36 xl:mb-0 max-sm:hidden flex gap-2 items-center"
          href="https://github.com/SAADTheNightWorker"
          target="_blank"
        >
          Gihub <FaGithub />
